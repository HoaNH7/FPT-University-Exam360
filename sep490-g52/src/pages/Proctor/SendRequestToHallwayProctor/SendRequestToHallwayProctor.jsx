...
import './SendRequestToHallwayProctor.scss';
...
const SendRequestToHallwayProctor = () => {
    ...
    const handleSaveRow = async (studentIdNumber, index) => {
        ...
        if (selectedRequests && selectedRequests.length > 0) {
            ...
            if (needsNote && note.trim() === '') {
                toast.error('Please provide a note for the selected request(s).');
                return;
            }
        ...
        <Fragment>
            ...
            <div className="main-container-sendrequest">
                <div className="sendrequest-management-header">
                    ...
                    {' > '}
                    <span style={{ fontSize: 14 }}>Send Request To Hallway Proctor</span>{' '}
                </div>
...
export default SendRequestToHallwayProctor;
